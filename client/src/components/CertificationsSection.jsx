...
const certifications = [
  { title: 'Advanced Java Development', issuer: 'Oracle', year: 2024 },
  { title: 'React Performance Mastery', issuer: 'Frontend Masters', year: 2025 },
  { title: 'Modern API Architecture', issuer: 'MongoDB University', year: 2025 }
];
  ...
  <section id="certifications" className="px-6 py-24 sm:px-10 lg:px-14">
    <div className="mx-auto max-w-6xl">
      <div className="mb-10">
        ...
        <h2 className="mt-4 text-4xl font-semibold text-white sm:text-5xl">Verified credentials for real product delivery.</h2>
      </div>
